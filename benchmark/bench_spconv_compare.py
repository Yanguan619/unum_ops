...
运行：
  ...
  python benchmark/bench_spconv_compare.py             # 默认 CPU + NPU（如可用）
  python benchmark/bench_spconv_compare.py --cpu-only  # 仅 CPU
  python benchmark/bench_spconv_compare.py --n 1000 --c 32 --spatial 30 30 30
"""
import argparse
import sys
import os
...
import unum_ops.spconv  # noqa: E402,F401
from unum_ops.spconv.conv import SubMConv3d, SparseConvolution  # noqa: E402
from unum_ops.spconv.sparse_modules import SparseConvTensor  # noqa: E402
